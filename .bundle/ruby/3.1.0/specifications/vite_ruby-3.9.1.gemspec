...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/ElMassimo/vite_ruby/blob/vite_ruby@3.9.1/vite_ruby/CHANGELOG.md", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/ElMassimo/vite_ruby/tree/vite_ruby@3.9.1/vite_ruby" } if s.respond_to? :metadata=
